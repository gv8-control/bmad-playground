...
6. Run: node scripts/pipeline/trace-view.mjs ${runId} <stepId> for any step whose journal excerpt surfaces a candidate signal. Default view is cheap; widen on suspicion, not eagerly. Read docs/trace-view-usage.md for the flag reference and widening guidance.
