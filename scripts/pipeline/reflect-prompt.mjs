...
Base your judgment only on the evidence above — this run's journal, cross-run trends, the ledger, runner-errors, and the actual step artifacts you read to confirm a candidate signal. Do not pull findings from unrelated reports or past pipeline generations.
