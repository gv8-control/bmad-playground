 ...
 *
 * Story 2.4 delivered the base component; Story 2.5 adds `href` and `selected`
 * props and changes the root element from `<div>` to `<Link>`. Story 5.4
 * fixes token-usage drift.
 *
